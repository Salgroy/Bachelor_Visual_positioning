dataSet         = fullfile(tempdir, 'Vanntank_24_fps', filesep);
dataSet2        = fullfile(tempdir, 'Bibliotek_24_fps', filesep);
dataSet3        = fullfile(tempdir, 'Aula_24_fps', filesep);
options         = weboptions(Timeout=Inf);

imageFolder1  = dataSet;
imageFolder2  = dataSet2;
imageFolder3  = dataSet3;
imds          = imageDatastore(imageFolder2);
